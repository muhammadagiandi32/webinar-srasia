...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200"
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <!--begin::Logo image-->
                                <a href="{{ url('/') }}">
                                    <img alt="Logo" src="{{ asset('assets/dist/assets/media/logos/logo-sr-asia.jpeg')}}"
                                        class="logo-default h-25px h-lg-80px" />
                                    <img alt="Logo" src="{{ asset('assets/dist/assets/media/logos/logo-sr-asia.jpeg')}}"
                            ...
                            <div class="d-lg-block" id="kt_header_nav_wrapper">
                                <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold"
                                        ...
                                        <div class="menu-item">
                                            <!--begin::Menu link-->
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#" target="_blankl"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true" id="about"
                                                onclick="show_my_receipt()">About SR
                                                Asia</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
    ...
    <script>
        function show_my_receipt() {
         ...
         var page = 'https://www.srasia-indo.com';
